...
struct parses_brackets_fixture {
	context_t context;
...
BOOST_FIXTURE_TEST_SUITE(parses_brackets,
						 parses_brackets_fixture)
	...
	BOOST_AUTO_TEST_CASE(case3) {
		...
		parse(tokens, tree, context);
		BOOST_CHECK(tree.src == (tree_src_t{
				{CALL_TREE_SRC_UNDEFINED, 1}, {CALL_TREE_SRC_UNDEFINED}, {0}
		}));
	}
	...
	BOOST_AUTO_TEST_CASE(case4) {
		...
		parse(tokens, tree, context);
		BOOST_CHECK(tree.src == (tree_src_t{
				{CALL_TREE_SRC_UNDEFINED, 3}, {CALL_TREE_SRC_UNDEFINED, 2}, {CALL_TREE_SRC_UNDEFINED}, {1}, {0}
		}));
	}
